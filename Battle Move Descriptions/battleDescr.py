...
binn.write(open("_Decompressed_00000024.bin", "rb").read())
binn.write(open("_Decompressed_00000B98.bin", "rb").read())
binn.write(open("_Decompressed_000010F0.bin", "rb").read())
binn.close()
